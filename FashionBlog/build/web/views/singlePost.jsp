                    ...
                    <div class="wrapper blog-post">
                        <div class="content">
                            ...
                            <div class="blog-post-body section">
                                <div class="controls">
                                    <span class="date-text" id="pLike"><s:property value="singlePost.getpLike()"/></span>
                                    <span><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>&nbsp;
                                    <span class="date-text" ><s:property value="singlePost.getpView()"/>
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </span>&nbsp;
                                    <span class="date-text"><s:property value="singlePost.getpDate()"/></span>

                                </div>
                                <div class="heading">
                                    <h4><s:property value="singlePost.getpName()"/></h4>
                                ...
                                <div class="content">
                                    <p>${post.getpIntroduction()}</p>
                                        <div class="image">
                                            <img src="<s:property value="singlePost.getpImage()"/>"/>
                                        </div><br>
                                    <p><s:property value="singlePost.getpContent()"/></p>
                                </div>
                            </div>
                            <ul class="pager">
...
<input type="hidden" id="pId-likePost" value='<s:property value="singlePost.getpId()"/>'/>
<input type="hidden" id="username-likePost" value="${account.getUsername()}"/>
</body>
<script>
    function likePost(){
