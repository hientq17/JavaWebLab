            ...
            <div class="row-fluid content-inner">
                <div id="left" class="span9">
                    <div class="wrapper blog">
                        ...
                        <div class="content">
                            <s:iterator value="listFamousPosts">
                                <div class="section">
                                    <div class="content">
                                        <div class="avatar">
                                        ...
                                        <div class="item">
                                            <div class="controls">
                                                <span class="date-text" id="pLike"><s:property value="getpLike()"/>
                                                    <i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span>&nbsp;
                                                <span class="date-text"><s:property value="getpView()"/>
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </span>&nbsp;
                                                <span class="date-text"><s:property value="getpDate()"/></span>
                                            </div>
                                            <div class="heading">
                                                <form action="single-post" method="post">
                                                    <input type="hidden" name="pId" value='<s:property value="getpId()"/>'>
