                                        ...
                                        <div class="outer-margin-on first last">
                                            <div class="section article margins-on">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p><span><strong>Name: </strong><s:property value="about.getaName()"/></span></p>
                                                    <p><span><strong>Age: </strong><s:property value="about.getaAge()"/></span></p>
                                                    <p><span><s:property value="about.getaDescription()"/></span></p>
                                                </div>
                                            </div>
